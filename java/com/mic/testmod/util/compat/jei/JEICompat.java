...
public class JEICompat implements IModPlugin {
	...
	public void register(IModRegistry registry) {
		...
		registry.addRecipeCategoryCraftingItem(new ItemStack(ModBlocks.COSMIC_FORGE), RecipeCategories.FORGE);
		...
		registry.addRecipeCategoryCraftingItem(new ItemStack(ModBlocks.COMPRESSOR), RecipeCategories.COMPRESSOR);
