...
public abstract class AbstractForgeRecipeCategroy<T extends IRecipeWrapper> implements IRecipeCategory<T>{
	...
	protected static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/cosmic_forge.png");
	
	public AbstractForgeRecipeCategroy(IGuiHelper helper){
