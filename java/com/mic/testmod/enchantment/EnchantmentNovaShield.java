package com.mic.testmod.enchantment;
...
public class EnchantmentNovaShield extends Enchantment {

	public EnchantmentNovaShield() {
		...
		this.setName("nova_shield");
		this.setRegistryName(Reference.MOD_ID + ":nova_shield");
